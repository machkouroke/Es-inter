...
<html lang="fr">
	<head>
		...
		<link rel="stylesheet" href="<?= CSS_URL ?>userspace.css"/>
	...
	<body class="is-preload">
		...
		<header id="header">
			...
			<div class="image phone">
				<div class="inner"><img src="<?= IMG_URL ?>phone.png" alt=""/></div>
			</div>
		</header>
		...
		<script src="<?= JS_URL?>jquery.scrolly.min.js"></script>
		<script src="<?= JS_URL?>browser.min.js"></script>
		<script src="<?= JS_URL?>breakpoints.min.js"></script>
